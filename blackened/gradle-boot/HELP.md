...
* The original package name 'org.sayner.sandbox.example.springboot.all-spring-boot' is invalid and this project uses 'org.sayner.sandbox.example.springboot.allspringboot' instead.
